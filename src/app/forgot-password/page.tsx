        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 20, padding: "36px 32px", boxShadow: "0 24px 60px rgba(0,0,0,0.5)" }}>
          {sent ? (
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: C.muted, fontSize: 14, margin: "0 0 24px 0", lineHeight: 1.6 }}>
                Vérifie ta boîte <strong style={{ color: C.white }}>{email}</strong> et clique sur le lien pour réinitialiser ton mot de passe.
              </p>
