...
export default function StockView({
  drivers, driverStocks, stockForm, stockLoading, tenantId,
  ...
  return (
    <div>
      ...
      {tab === "entrepot" && (
        <div>
          {/* Formulaire ajout */}
          <div style={{ maxWidth: 560, marginBottom: 32, background: S.card, border: `1px solid ${S.border}`, borderRadius: 16, padding: 24 }}>
            <p style={{ fontSize: 15, fontWeight: 700, color: S.text, marginBottom: 16 }}>Ajouter du stock à un livreur</p>
